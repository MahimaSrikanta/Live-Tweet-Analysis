...
import itu.bigdata.tools.CountiesLookup;
...
public class ParseTweetBolt extends BaseRichBolt
{
  ...
  private String[] electionWords = {"obama","OBAMA","Hillary","HILLARY","hillary","Clinton","clinton","Trump","TRUMP"};
  //MaxentTagger tagger ;
  ...
  public void execute(Tuple tuple)
  {
    ...
    if(posTweet != null)
    { 
 //   for (String w: electionWords)
 //   {
 //     if ( tweet.toLowerCase().indexOf(w.toLowerCase()) != -1 )
 //    {
      ...
      System.out.print("\tParseTweetBolt\tDEBUG:" + tweet + ", URL: " + url + "\n");
      }
//    }
//    }
  }
